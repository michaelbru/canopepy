...
#from transaction import ModbusSocketFramer, ModbusBinaryFramer
#from transaction import ModbusAsciiFramer, ModbusRtuFramer
from common import CanopenClientMixin
...
#---------------------------------------------------------------------------#
class BaseCanopenClient(CanopenClientMixin):
    '''
    Inteface for a canopen synchronous client. Defined here are all the
...
class ModbusTcpClient(BaseModbusClient):
    ...
    def __init__(self, host = 0, port=Defaults.Port,
